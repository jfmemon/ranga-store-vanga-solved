...
document.getElementById("search-btn").addEventListener("click", function () {
   ...
   // ekhane filter korbe protita product(p) ke. Filter kore title take lowercase kore nibe, tarpor shei title er moddhe includes korche kina- jeta ami search korchi.
